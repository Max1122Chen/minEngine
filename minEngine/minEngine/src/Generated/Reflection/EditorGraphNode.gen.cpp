...
#include "Runtime/Function/EditorGraph/EditorGraphNode.h"

ME_REFLECTION_CLASS_DEFINE_BEGIN(minEngine::EditorGraphNode, GReflectionClassRegister_EditorGraphNode_921932ce)
...
ME_REFLECTION_CLASS_DEFINE_END(minEngine::EditorGraphNode)
