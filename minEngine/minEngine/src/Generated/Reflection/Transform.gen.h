...
ME_REFLECT_TYPE_BEGIN(minEngine::Transform)
    ME_REFLECT_FIELD(minEngine::Transform, Position, minEngine::Reflection::MetaKV("EditAnywhere", "true"))
    ME_REFLECT_FIELD(minEngine::Transform, Rotation, minEngine::Reflection::MetaKV("EditAnywhere", "true"))
    ME_REFLECT_FIELD(minEngine::Transform, Scale, minEngine::Reflection::MetaKV("EditAnywhere", "true"))
