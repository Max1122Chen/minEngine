...
namespace minEngine::DebugCommand
{
    namespace
    {
            ...
            PropertyValueValidation& validation)
        {
            const std::optional<std::string> constraintError =
                DebugCommandSetValueValidation::ValidateNumericConstraints(info, numericValue);
    ...
    SetValuePhase DebugCommandSetValueValidation::ParseValuePhase(std::string_view line)
    {
        SetValuePhase phase;
    ...
    bool DebugCommandSetValueValidation::TryGetValueInfo(
        ...
        PropertySetValueInfo& outInfo)
    {
        ...
        DebugCommandSetValueValidation::PopulatePropertyConstraints(*leafProperty, outInfo);
    ...
    PropertyValueValidation DebugCommandSetValueValidation::ValidateValuePrefix(
        const PropertySetValueInfo& info,
        std::string_view valuePrefix)
    {
        PropertyValueValidation validation;
    ...
    PropertyValueValidation DebugCommandSetValueValidation::ValidateInputLine(
        const DebugCommandContext& context,
    ...
    PropertyValueValidation DebugCommandSetValueValidation::ValidateSetLiteral(
        const DebugCommandContext& context,
        std::string_view propertyPathText,
    ...
    void DebugCommandSetValueValidation::PopulatePropertyConstraints(
    ...
    std::optional<std::string> DebugCommandSetValueValidation::ValidateNumericConstraints(
        const PropertySetValueInfo& info,
        double numericValue)
    {
    ...
    std::vector<CompletionItem> DebugCommandSetValueValidation::CompleteValue(
        const DebugCommandContext& context,
