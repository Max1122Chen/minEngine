...
namespace minEngine
{
    EditorRemoveComponentCommand::EditorRemoveComponentCommand(SceneEditor& sceneEditor,
    ...
    void EditorRemoveComponentCommand::Execute()
    {
        m_Removed = false;
        ...
        {
            ME_LOG(LogEditor, Error, "EditorRemoveComponentCommand: failed to write snapshot envelope.");
            return;
        }
    ...
    void EditorRemoveComponentCommand::Undo()
    {
        ...
        {
            ME_LOG(LogEditor, Error, "EditorRemoveComponentCommand: failed to read snapshot envelope.");
            return;
        }
    ...
    const char* EditorRemoveComponentCommand::GetDescription() const
    {
