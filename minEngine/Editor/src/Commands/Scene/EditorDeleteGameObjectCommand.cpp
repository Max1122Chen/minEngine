...
namespace minEngine
{
    EditorDeleteGameObjectCommand::EditorDeleteGameObjectCommand(SceneEditor& sceneEditor, uint64_t gameObjectId)
    ...
    void EditorDeleteGameObjectCommand::Execute()
    {
        m_Removed = false;
        ...
        {
            ME_LOG(LogEditor, Error, "EditorDeleteGameObjectCommand: failed to write snapshot envelope.");
            return;
        }
    ...
    void EditorDeleteGameObjectCommand::Undo()
    {
        ...
        {
            ME_LOG(LogEditor, Error, "EditorDeleteGameObjectCommand: failed to read snapshot envelope.");
            return;
        }
    ...
    const char* EditorDeleteGameObjectCommand::GetDescription() const
    {
