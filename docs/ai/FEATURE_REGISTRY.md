...
Last updated: 2026-09-04（CORE-F08 Review，待 ED-F05 联合验收）
...
| `ED-F05` | Hierarchy 树形显示 + 拖拽改父 | **Draft** | — | [Design](./Editor/ED-F05_HIERARCHY_TREE_DESIGN.md) · 依赖 `CORE-F08` · `feat/ui` |
