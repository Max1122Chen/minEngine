...
Last updated: 2026-07-24 (RND-F06 Planned)  
...
| `RND-F01` | RenderGraph（Manual → Baked；图 `RenderPass`；S0–S04 Done） | **Draft** | — | [RND-F01_RENDER_GRAPH_DESIGN](./Render/RND-F01_RENDER_GRAPH_DESIGN.md) · **S05+ 依赖 F06 Done**（卫生→Bake→调图形态） |
