...
| `ED-F03` | Debug Console & Unified Command System（Runtime 控制面 + Agent-friendly） | **In Progress** | — | [Design](./Editor/ED-F03_DEBUG_CONSOLE_COMMAND_SYSTEM_DESIGN.md) · **`feat/editor`** · S04c Done（value 补全 + 校验着色 + enum set）；待 S06 / S07 |
