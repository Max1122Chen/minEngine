...
| `RND-F05` | Vulkan backend + SPIR-V（GL+VK）+ modern RHI completion | **In Progress** | S03 | [Design](./Render/RND-F05_VULKAN_MODERN_RHI_COMPLETION_DESIGN.md) · [Impl](./Render/RND-F05_VULKAN_MODERN_RHI_COMPLETION_IMPLEMENTATION.md) · S01–S02 Done；下一刀 `--rhi` + VK Present |
