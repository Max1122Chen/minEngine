...
Last updated: 2026-06-11 (RND-F01 Draft)  
...
| `RND-F01` | RenderGraph（Manual → Baked；图 `RenderPass`；S0 Binding Done） | **Draft** | — | [RND-F01_RENDER_GRAPH_DESIGN](./Render/RND-F01_RENDER_GRAPH_DESIGN.md) · S01 next |
...
| `RND` | F06 | F01 RenderGraph (Deferred); F02 Done; F03–F05 render track |
