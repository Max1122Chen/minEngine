...
| `RND-F03` | Legacy RHI removal（GL-only；终局一次迁移、删 Legacy） | Done | — | [RND-F03_LEGACY_RHI_REMOVAL_DESIGN](./Render/RND-F03_LEGACY_RHI_REMOVAL_DESIGN.md) · [Blueprint](./Render/RND-F03_MIGRATION_BLUEPRINT.md) |
