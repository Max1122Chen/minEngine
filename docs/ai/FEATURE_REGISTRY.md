...
Last updated: 2026-09-02（`feat/editor`：ED-F03 S03–S04b Done）
...
| `CORE-F07` | 反射/Inspector 展示名（去 `m_`/`x_`/`b_` 前缀 + 驼峰分词） | **Done** | — | [Design](./Platform/Core/CORE-F07_REFLECTION_DISPLAY_NAMES_DESIGN.md) · **`feat/editor`** |
...
| `ED-F03` | Debug Console & Unified Command System（Runtime 控制面 + Agent-friendly） | **In Progress** | — | [Design](./Editor/ED-F03_DEBUG_CONSOLE_COMMAND_SYSTEM_DESIGN.md) · **`feat/editor`** · S03–S04b Done（find + CompletionService + IDE 补全 UX）；待 S04c / S06 / S07 |
