...
Last updated: 2026-09-09（ED-F05 S00–S04 Done；S05 Deferred）
...
**`ED-F05` Inspector / Component UX：** S00–S04 **Done**（`feat/editor`）；视口图标 **S05 Deferred** — [Design](./Editor/ED-F05_INSPECTOR_COMPONENT_UX_DESIGN.md) · [Impl](./Editor/ED-F05_INSPECTOR_COMPONENT_UX_IMPLEMENTATION.md)。验收反馈 polish 已编过；再手测后 **准备 commit**。
...
| **ED-F05** S00–S04 | Done on `feat/editor`（S05 Deferred） |
| **PHYS-F04** / BUG-PHYS-003/004 | Done / Fixed |
| **feat/editor** merge | 先前批次已合入 `master`；本批 ED-F05 待 commit |
...
| `D:/Dev/GitRepo/minEngine-editor` | `feat/editor` | DX — **ED-F05** S00–S04 Done（待手测 / commit） |
