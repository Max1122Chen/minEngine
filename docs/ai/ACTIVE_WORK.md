...
Last updated: 2026-09-14（ED-F13 Done；下一刀 ED-F14 或准备 commit）  
...
| 5 | **`ED-F14`** | 各 SubEditor 命令面完备 | **Planned** | [Design](./Editor/ED-F14_EDITOR_COMMAND_COVERAGE_DESIGN.md) |
| — | `ED-F10` | EditorSettings | **Planned**（占位） | Design 未开 |

**下一刀：** 准备 ED-F13 commit；或开 **ED-F14** Design 审批/实现。
