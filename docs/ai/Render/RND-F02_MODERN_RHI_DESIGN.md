...
- **Related:** [FEATURE_REGISTRY](../FEATURE_REGISTRY.md) · [ACTIVE_WORK](../ACTIVE_WORK.md) · [RND-F03](./RND-F03_LEGACY_RHI_REMOVAL_DESIGN.md)（Legacy 清零）· [RND-F04](./RND-F04_MODERN_RHI_EVOLUTION_DESIGN.md)（语义演进）· [RND-F05](./RND-F05_VULKAN_MODERN_RHI_COMPLETION_DESIGN.md)（Vulkan）· [RENDER_REFACTOR_PLAN](./RENDER_REFACTOR_PLAN.md)
